...
/**
 * Testing reads on larger data with a 'submit' transaction in Hyperledger Fabric
 */
...
const csvWriter = createCsvWriter({
  path: 'read-focused_submit_largeData.csv',
  header: [
...
async function main() {
	try {
		...
		try {
			...
			console.log(`Average time for read-focused small data submits: ${averageTime}`);
